 ...
 */
final class Version20210206044126 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article DROP prix_minimum');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD prix_minimum INT NOT NULL');
    }
}
